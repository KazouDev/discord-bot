...
client.on('ready', () => {
    ...
    client.user.setActivity(`Vinted BOT`);
});

client.on('interactionCreate', (interaction) => {
    console.log("OKAY")
    if (!interaction.isCommand()) return;
    if (!interaction.member.permissions.has("ADMINISTRATOR")) return void interaction.reply(`:x: Vous ne disposez pas des droits pour effectuer cette action !`);
